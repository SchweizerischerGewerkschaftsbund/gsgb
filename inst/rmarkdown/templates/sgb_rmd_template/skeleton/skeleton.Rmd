...
knitr::opts_chunk$set(echo = TRUE, warning=FALSE, message=FALSE, dpi=600)#, fig.width=4.5, fig.height=3)
...
### Plot Titel
#### (Plot Untertitel)
```{r plot1, echo=FALSE, fig.height=2.5, fig.width=3.5, fig.cap="Quelle: Fisher, R. A. (1936)"}
